...
let questions = [
  new Question(
    "Who created JAVA?",
    ["Mar Java", "Mitt Java","Lut Java", "Sun Java"],
    "Sun Java"
  ),
  new Question(
...
function showScores() {
  ...
  gameOverHTML += `<h2 id='score'> Your Score is:- ${
    quiz.score
  } out of ${questions.length} <br> Your marks percentage is :- ${(quiz.score / questions.length) * 100}% </h1>`;

  gameOverHTML += '<body> <center> <a href="quiz.html"> Restart Quiz</a> </center> </body>'
